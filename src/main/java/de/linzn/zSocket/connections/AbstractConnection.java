...
public abstract class AbstractConnection implements Runnable {
     ...
     */
    public AbstractConnection(Socket socket, IZMask zMask, CryptContainer cryptContainer, UUID uuid, EventBus eventBus) {
        this.socket = socket;
        this.zMask = zMask;
